...
val GuildMessageChannel.locale: Locale
    get() = this.guild.locale.toLocale()

fun GuildMessageChannel.sendLocalizedMessage(key: String, locale: Locale, vararg data: Any?): MessageCreateAction {
    return this.sendMessage(locale.translate(key, *data))
}
fun GuildMessageChannel.sendLocalizedMessage(key: String, vararg data: Any?): MessageCreateAction {
