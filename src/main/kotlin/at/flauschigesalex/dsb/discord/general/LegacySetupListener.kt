...
@Deprecated("Improve with future patch") // TODO
object LegacySetupListener : ListenerAdapter() {
    ...
    override fun onMessageReceived(event: MessageReceivedEvent) {
        ...
        if (args.getOrNull(1).equals("setup", true)) {
            if (args.getOrNull(2).equals("message", true)) {
                ...
                val category = guild.config?.supportCategories?.find { it.id.equals(id, true) } ?: return
